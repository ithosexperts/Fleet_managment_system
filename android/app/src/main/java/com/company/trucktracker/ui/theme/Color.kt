...
// Dark Theme Colors (HoseXperts Logistics Design System)
val CharcoalBg = Color(0xFF0B101B)
val CharcoalSurface = Color(0xFF111827)
val CharcoalCard = Color(0xFF162032)
val CharcoalBorder = Color(0xFF233044)

val HoseXpertsBlue = Color(0xFF1764A8)
